...
resize: svg2png resize100 resize64 resize32
...
resize32:
	convert ${CODEIVATE:.svg=_500.png}	-resize 32x32 ${CODEIVATE:.svg=_32.png}
	convert ${CODERBITS:.svg=_500.png}	-resize 32x32 ${CODERBITS:.svg=_32.png}
	convert ${COMMENTS:.svg=_500.png}	-resize 32x32 ${COMMENTS:.svg=_32.png}
	convert ${FACEBOOK:.svg=_500.png}	-resize 32x32 ${FACEBOOK:.svg=_32.png}
	convert ${GITHUB:.svg=_500.png}		-resize 32x32 ${GITHUB:.svg=_32.png}
	convert ${GSCHOLAR:.svg=_500.png}	-resize 32x32 ${GSCHOLAR:.svg=_32.png}
	convert ${GPLUS:.svg=_500.png}		-resize 32x32 ${GPLUS:.svg=_32.png}
	convert ${LINKEDIN:.svg=_500.png}	-resize 32x32 ${LINKEDIN:.svg=_32.png}
	convert ${MENDELEY:.svg=_500.png}	-resize 32x32 ${MENDELEY:.svg=_32.png}
	convert ${RESEARCH:.svg=_500.png}	-resize 32x32 ${RESEARCH:.svg=_32.png}
	convert ${RSS:.svg=_500.png}		-resize 32x32 ${RSS:.svg=_32.png}
	convert ${SHAARLI:.svg=_500.png}	-resize 32x32 ${SHAARLI:.svg=_32.png}
	convert ${TWITTER:.svg=_500.png}	-resize 32x32 ${TWITTER:.svg=_32.png}
	convert ${VIADEO:.svg=_500.png}		-resize 32x32 ${VIADEO:.svg=_32.png}
